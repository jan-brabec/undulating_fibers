...
%         plot(bd_n(1)*1e-9+0.2,Sd_n(1),'.','Markersize',50,'Color',pl_color('1-harm'))
%         
%         plot(bd_n(2)*1e-9,Sd_n(2),'s','MarkerSize',14,'MarkerEdgeColor',col2, 'MarkerFaceColor',col2)        
% 
%         plot(bd_n(3)*1e-9,Sd_n(3),'p','MarkerSize',14,'MarkerEdgeColor',col2, 'MarkerFaceColor',col2)        
%              
%         plot(bd_n(4)*1e-9,Sd_n(4),'^','MarkerSize',14,'MarkerEdgeColor',col2, 'MarkerFaceColor',col2)          
