...
if (1)
    addpath('../undulating_structures/Monte Carlo/MC_functions')
    addpath('../undulating_structures/Spectral Analysis/SA_functions')
    addpath('../undulating_structures/Analytical/f_functions')
...
if (1) %trajectory with a, lambda
    load('../undulating_structures/Spectral Analysis/res/res_3_50.mat','f','ft_ac')
...
save tmp_dl_0_01_each_25_a_1_L_10_1_mil_d_1.mat